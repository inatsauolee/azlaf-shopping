...
<body>
	...
	<div class="middleContainer" align="center">
		...
		<div id="pubTable">
			<table >
				<s:form commandName="postData"
					...
					<tr>
						<td class="text"><s:textarea path="p_text"
								placeholder="Post something to sell..." /></td>
						<td class="text"><s:errors path="p_text"
								cssStyle="color:red;" /></td>
					</tr>


					<tr>
						<td class="positionLabel">Enter a Price ($):</td>
						<td class="positionInput"><s:input path="p_price" /></td>
						<td class="positionErr"><s:errors path="p_price"
								cssStyle="color:red;" /></td>
					</tr>
					...
					<tr>
						<td><a class="comment"
							href="${pageContext.request.contextPath}/post/showalone?postId=${post.getP_id()}">
								<img src="<c:url value='/resources/img/comments.png'/>"
								width="33" height="33" />
						</a></td>
					</tr>
					<tr>
		...
		</c:forEach> <input class="seemore" type="submit" value="See More!" /> 
		</section>
	</div>
